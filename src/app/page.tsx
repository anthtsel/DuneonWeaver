...
export default function DungeonWeaverPage() {
  ...
  }, [startGameLogic, toast]); // toast added to dependencies
    ...
    try {
      ...
      if (result.gameOver) {
        ...
        const newRun: PastRunDataType = {
          id: gameStartTimeRef.current + '-' + runEndTime, // More unique ID
      ...
      setInputValue(currentAction); // Put action back if failed
    } finally {
      setIsLoading(false);
    }
  };
          ...
          {!gameEnded ? (
            ...
            <CardFooter className="p-4 border-t border-border flex-col items-center justify-center">
              <div className="text-center animate-fadeIn">
                ...
                <p className="text-muted-foreground mb-4">Turns taken: {turnCount}</p>
